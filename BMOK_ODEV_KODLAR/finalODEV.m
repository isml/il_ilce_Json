clear all;
FG =imread("C:/Users/ismail/Desktop/d/deneme.jpg");
BG =imread("C:/Users/ismail/Desktop/d/denemebg.jpg");
...
satMask = (S >= 60) & (S <= 120);
valMask = (V >= 70) & (V <= 120);
#HUE,SATURATION VE VALUE DEGERLERI ICIN MINUMUM VE MAKSIMUM ESIK DEGERLERI
#TANIMLANDI [14-16]
