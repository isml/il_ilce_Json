clear all;
FG =imread("C:/Users/ismail/Desktop/d/1.jpg");
BG =imread("C:/Users/ismail/Desktop/d/bg1.jpg");
...
hueMask = (H >= 60) & (H <= 125);
#HUE DEGERLERI ICIN MINUMUM VE MAKSIMUM ESIK DEGERLERI TANIMLANDI [14]
maske = uint8(hueMask );
maskAna = FG.*maske;
...
#ILE CARPILARAK MASKELENMIS ANA RESIM CIKTISI ELDE EDILDI[17-19]
...
#VE VALUE KATMANI ELE ALINDI [22-23]
